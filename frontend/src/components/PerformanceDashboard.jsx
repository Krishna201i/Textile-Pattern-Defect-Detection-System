...
export default function PerformanceDashboard() {
  ...
  if (error && !metrics) {
    return (
      <div className="error-card">
        <FiAlertCircle /> Failed to connect to performance monitoring. The backend API is not responding. Please ensure the Python backend is running on port 5000.
      </div>
    );
  }
  ...
  return (
    <div className="fade-in" style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      ...
      <h3 style={{ fontFamily: '"Space Grotesk", system-ui, sans-serif', fontSize: '1.25rem', margin: 0, color: 'var(--text-primary)', display: 'flex', alignItems: 'center', gap: '8px' }}>
      ...
      {/* Network & API Load */}
      <h3 style={{ fontFamily: '"Space Grotesk", system-ui, sans-serif', fontSize: '1.25rem', margin: '12px 0 0 0', color: 'var(--text-primary)', display: 'flex', alignItems: 'center', gap: '8px' }}>
      ...
      <div className="stats-grid">
        ...
        <div className="stat-card">
          ...
          <div className="stat-info">
            <h4>{api.avg_latency_ms.toFixed(1)} ms</h4>
            <p>Avg Latency</p>
          </div>
        </div>
        ...
        <div className="stat-card">
          ...
          <div className="stat-info">
            <h4>{api.error_rate_percent.toFixed(1)}%</h4>
            <p>API Error Rate</p>
          </div>
        </div>

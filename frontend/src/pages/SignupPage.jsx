        ...
        <div className="auth-split">
          ...
          <div className="auth-side auth-side-illustration auth-side-pro" style={{
            ...
            <div className="brand auth-brand-pro" style={{ position: "relative", zIndex: 1 }}>
              <p className="auth-eyebrow" style={{ letterSpacing: "2px", color: "var(--primary)" }}>Start Your Journey</p>
              ...
              <p style={{ lineHeight: "1.6", marginTop: "10px", color: "var(--text-secondary)" }}>Set up secure access to quality analytics and team workflows.</p>
            </div>
